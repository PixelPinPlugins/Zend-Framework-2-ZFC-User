ZfcUserPixelpin
=======
[![Build Status](https://travis-ci.org/ZF-Commons/ZfcUserPixelpin.png)](https://travis-ci.org/ZF-Commons/ZfcUserPixelpin)
[![Code Coverage](https://scrutinizer-ci.com/g/ZF-Commons/ZfcUserPixelpin/badges/coverage.png?s=7d5932c77bea64a417ac8e3da51dca6da1fcb22e)](https://scrutinizer-ci.com/g/ZF-Commons/ZfcUserPixelpin/)
...
2. Now tell composer to download ZfcUserPixelpin by running the command:
...
2. Then Import the SQL schema located in `./vendor/zf-commons/zfc-user/data/schema.sql` (if you installed using the Composer) or in `./vendor/ZfcUserPixelpin/data/schema.sql`.
...
The ZfcUserPixelpin module has some options to allow you to quickly customize the basic
functionality. After installing ZfcUserPixelpin, copy
    ...
    return array(
        'di'=> array(
            'instance'=>array(
                ...
                'ZfcUserPixelpin\Form\Register' => array(
                    'parameters' => array(
