    ...
    UserServiceOptionsInterface
{
     ...
     * @var array
     */
    protected $authAdapters = array( 100 => 'ZfcUserPixelpin\Authentication\Adapter\Db' );
     ...
     * @var string
     */
    protected $userEntityClass = 'ZfcUserPixelpin\Entity\User';

    /**
     * @var string
     */
    protected $userLoginWidgetViewTemplate = 'zfc-user-pixelpin/user/login.phtml';
