...
class AdapterChainTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::authenticate
     */
    public function testAuthenticate()
    {
        $event = $this->getMock('ZfcUserPixelpin\Authentication\Adapter\AdapterChainEvent');
    ...
    /**
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::resetAdapters
     */
    public function testResetAdapters()
    {
        ...
        for ($i=1; $i<=3; $i++) {
            $storage = $this->getMock('ZfcUserPixelpin\Authentication\Storage\Db');
            $storage->expects($this->once())
                    ->method('clear');

            $adapter = $this->getMock('ZfcUserPixelpin\Authentication\Adapter\AbstractAdapter');
        ...
        $this->assertInstanceOf('ZfcUserPixelpin\Authentication\Adapter\AdapterChain', $result);
    }
    ...
    protected function setUpPrepareForAuthentication()
    {
        ...
        $this->event = $this->getMock('ZfcUserPixelpin\Authentication\Adapter\AdapterChainEvent');
     ...
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::prepareForAuthentication
     */
     ...
     *
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::prepareForAuthentication
     * @expectedException ZfcUserPixelpin\Exception\AuthenticationEventException
     */
     ...
     *
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::getEvent
     */
    public function testGetEventWithNoEventSet()
    {
        ...
        $this->assertInstanceOf(
            'ZfcUserPixelpin\Authentication\Adapter\AdapterChainEvent',
            $event,
            'Asserting the adapter in an instance of ZfcUserPixelpin\Authentication\Adapter\AdapterChainEvent'
        );
        $this->assertEquals(
            $this->adapterChain,
            $event->getTarget(),
     ...
     *
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::setEvent
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::getEvent
     */
    public function testGetEventWithEventSet()
    {
        $event = new \ZfcUserPixelpin\Authentication\Adapter\AdapterChainEvent();
     ...
     * @covers ZfcUserPixelpin\Authentication\Adapter\AdapterChain::logoutAdapters
     */
