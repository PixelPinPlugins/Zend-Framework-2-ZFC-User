...
class AdapterChainServiceFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \ZfcUserPixelpin\Options\ModuleOptions
     */
    protected $options;
    ...
    protected function setUp()
    {
        ...
        $this->options = $this->getMockBuilder('ZfcUserPixelpin\Options\ModuleOptions')
    ...
    /**
     * @covers \ZfcUserPixelpin\Authentication\Adapter\AdapterChainServiceFactory::createService
     */
    public function testCreateService()
    {
        $adapter = array(
            'adapter1'=> $this->getMock(
                'ZfcUserPixelpin\Authentication\Adapter\AbstractAdapter',
        ...
        $this->assertInstanceOf('ZfcUserPixelpin\Authentication\Adapter\AdapterChain', $adapterChain);
        $this->assertEquals(array('authenticate', 'logout'), $adapterChain->getEventManager()->getEvents());
    }

    /**
     * @covers \ZfcUserPixelpin\Authentication\Adapter\AdapterChainServiceFactory::setOptions
     * @covers \ZfcUserPixelpin\Authentication\Adapter\AdapterChainServiceFactory::getOptions
     */
    ...
    /**
     * @covers \ZfcUserPixelpin\Authentication\Adapter\AdapterChainServiceFactory::getOptions
     * @expectedException \ZfcUserPixelpin\Authentication\Adapter\Exception\OptionsNotFoundException
     */
