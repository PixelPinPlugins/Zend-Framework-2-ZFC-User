...
namespace ZfcUserPixelpinTest\Controller;

use Zend\Form\FormElementManager;
use ZfcUserPixelpin\Controller\RedirectCallback;
use ZfcUserPixelpin\Controller\UserController as Controller;
use Zend\Http\Response;
use Zend\Stdlib\Parameters;
use Zend\ServiceManager\ServiceLocatorInterface;
use ZfcUserPixelpin\Service\User as UserService;
use Zend\Form\Form;
use ZfcUserPixelpin\Options\ModuleOptions;
use ZfcUserPixelpin\Entity\User as UserIdentity;
...
class UserControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->redirectCallback = $this->getMockBuilder('ZfcUserPixelpin\Controller\RedirectCallback')
        ...
        $this->zfcUserAuthenticationPlugin = $this->getMock('ZfcUserPixelpin\Controller\Plugin\ZfcUserAuthentication');
    ...
    public function setUpZfcUserPixelpinAuthenticationPlugin($option)
    {
    ...
    public function testActionControllHasIdentity($methodeName, $hasIdentity, $redirectRoute, $optionGetter)
    {
        ...
        $this->setUpZfcUserPixelpinAuthenticationPlugin(array(
    ...
    public function testLoginActionValidFormRedirectFalse($isValid, $wantRedirect)
    {
        ...
        $plugin = $this->setUpZfcUserPixelpinAuthenticationPlugin(array(
            'hasIdentity'=>false
        ));
        ...
        $form = $this->getMockBuilder('ZfcUserPixelpin\Form\Login')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        if ($isValid) {
            $adapter = $this->getMock('ZfcUserPixelpin\Authentication\Adapter\AdapterChain');
    ...
    public function testLoginActionIsNotPost($redirect)
    {
        ...
        $this->assertInstanceOf('ZfcUserPixelpin\Form\Login', $result['loginForm']);
    ...
    public function testRegisterAction($wantRedirect, $postRedirectGetReturn, $registerSuccess, $loginAfterSuccessWith)
    {
        ...
        $userService = $this->getMock('ZfcUserPixelpin\Service\User');
