...
use ZfcUserPixelpin\Form\ChangeEmailFilter as Filter;
...
class ChangeEmailFilterTest extends \PHPUnit_Framework_TestCase
{
    public function testConstruct()
    {
        ...
        $validator = $this->getMockBuilder('ZfcUserPixelpin\Validator\NoRecordExists')->disableOriginalConstructor()->getMock();
