...
use ZfcUserPixelpin\Mapper\User as Mapper;
use ZfcUserPixelpin\Entity\User as Entity;
use Zend\Db\ResultSet\HydratingResultSet;
use Zend\Db\Adapter\Adapter;
use ZfcUserPixelpin\Mapper\UserHydrator;

class UserTest extends \PHPUnit_Framework_TestCase
{
    /** @var \ZfcUserPixelpin\Mapper\User */
    protected $mapper;
...
//         $this->setUpAdapter('pgsql');
    ...
    public function testIntegrationFindBy($methode, $args, $expectedParams, $eventListener, $entityEqual)
    {
        ...
        foreach ($this->realAdapter as $dbAdapter) {
            ...
            $this->assertInstanceOf('ZfcUserPixelpin\Entity\User', $return);
            $this->assertEquals($entityEqual, $return);
        }
    ...
    {
        $this->mapper->setTableName('ZfcUserPixelpin');
        $this->assertEquals('ZfcUserPixelpin', $this->mapper->getTableName());
    }
